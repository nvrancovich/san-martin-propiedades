...
feature_latitude = st.slider('Latitud en el mapa', min=min(df['latitude']), max=max(df['latitude']))  
feature_longitude = st.slider('Longitud en el mapa', min=min(df['longitude']), max=max(df['longitude']))  